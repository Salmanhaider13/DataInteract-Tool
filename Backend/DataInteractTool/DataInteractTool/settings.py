"""
Django settings for DataInteractTool project.
...
SECRET_KEY = 'django-insecure-(w8bjoch3!l1gz3ea5)hp5ft2@j9o4oo(bss_%62%)vk=&x^(u'
...
ROOT_URLCONF = 'DataInteractTool.urls'
...
WSGI_APPLICATION = 'DataInteractTool.wsgi.application'
